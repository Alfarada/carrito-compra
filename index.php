...
<div class="row">
    ...
    <?php foreach ($productsList as $product) { ?>
        ...
        <div class="col-3">
            <div class="card">
                <!-- image -->
                <img class="card-img-top" data-toggle="popover" data-content="<?= $product['description']; ?>" data-trigger="hover" title=" <?= $product['name']; ?> " alt=" <?= $product['name']; ?>" src="<?= $product['image']; ?>" height="317px">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <button class="btn btn-primary" name="btnAction" value="add" type="submit">Agregar al carro</button>
